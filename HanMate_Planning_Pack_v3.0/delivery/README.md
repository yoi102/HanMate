...
> 历史归档：本文描述 2026-09-20 的 D8 内部交付，不是当前 0.1.3 GitHub 预览包的安装说明。当前入口见[仓库 README](../../README.md)、[0.1.3 版本说明](../../docs/releases/0.1.3.md)及[开发状态](../tracking/STATUS.md)。以下包名、哈希和设备状态只适用于当时的归档。
