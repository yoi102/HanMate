...
校验时间（UTC）：2026-09-20T12:01:30.325869+00:00。此报告仅覆盖开发文档、契约与工程样例，**不是 MAUI 应用测试报告**。

执行命令：`python tools/verify_bundle.py --write-report`

| 项目 | 结果 | 实际检查 |
|---|---|---|
| 本地链接与代码围栏 | PASS | 322 local Markdown links exist; fences balanced (excluding archive) |
...
| 派生文档与真源一致 | FAIL | ValueError: stale generated document: HanMate_Complete_Planning_v3.0.md; run tools/build_bundle.py --write |
